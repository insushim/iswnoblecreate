...
JSON 형식으로만 응답해주세요.`;
      ...
      const emotionResult = await generateJSON(settings.geminiApiKey, emotionPrompt) as {
...
JSON 형식으로만 응답해주세요.`;
      ...
      const styleResult = await generateJSON(settings.geminiApiKey, stylePrompt) as {
...
최대 5개의 제안과 3개의 일관성 문제를 JSON 형식으로만 응답해주세요.`;
      ...
      const suggestionResult = await generateJSON(settings.geminiApiKey, suggestionPrompt) as {
