...
╔══════════════════════════════════════════════════════════════════╗
║  ⛔ 이 규칙을 어기면 생성된 모든 내용이 무효화됩니다!           ║
║  ⛔ 반드시 모든 규칙을 100% 준수하세요!                         ║
╚══════════════════════════════════════════════════════════════════╝

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
### 🔴🔴🔴 1. 씬 범위 엄격 준수 (CRITICAL - 가장 중요!!!) 🔴🔴🔴
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

╔══════════════════════════════════════════════════════════════════╗
║  ⛔⛔⛔ 씬에 정해진 내용만 작성하세요!!! ⛔⛔⛔                 ║
║  ⛔⛔⛔ mustInclude 외 새로운 사건 금지!!! ⛔⛔⛔               ║
║  ⛔⛔⛔ 씬의 장소/시간/인물 외 등장 금지!!! ⛔⛔⛔             ║
╚══════════════════════════════════════════════════════════════════╝

**절대 금지 (위반 시 즉시 실패):**
- ❌ **씬에 정의된 mustInclude 외 다른 사건/갈등 만들기 금지**
- ❌ **씬에 정의된 장소 외 다른 장소 등장 금지**
- ❌ **씬에 정의된 등장인물 외 다른 인물 등장 금지**
- ❌ **씬에 정의된 시간대 외 다른 시간 묘사 금지**
- ❌ **씬의 시작점 이전 내용 작성 절대 금지**
- ❌ **씬의 종료점 이후 내용 작성 절대 금지**
- ❌ **다음 씬 내용 미리 작성 절대 금지**
- ❌ **이전 씬 내용 다시 작성 절대 금지**
- ❌ **분량 채우려고 새 사건/인물/장소 추가 절대 금지**

**필수 준수:**
- ✅ **오직 현재 씬의 mustInclude 내용만 작성**
- ✅ **오직 현재 씬의 장소에서만 진행**
- ✅ **오직 현재 씬의 등장인물만 등장**
- ✅ **오직 현재 씬의 시작~종료 조건 사이만 작성**

**⚠️⚠️⚠️ 분량이 부족하면?**
→ 새 사건 추가 금지!!!
→ 새 인물 등장 금지!!!
→ 새 장소 이동 금지!!!
→ 대신: 현재 장면의 감정, 분위기, 디테일을 더 깊게 묘사하세요!

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
### 🔴🔴🔴 2. 스토리 점프 완전 차단 (CRITICAL!!!) 🔴🔴🔴
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
**금지 표현 (사용 시 즉시 실패):**
- ❌ "며칠이 지나", "몇 달이 흘러", "시간이 흘러", "세월이"
- ❌ "어느덧", "그 후로", "한참 후", "얼마 후", "잠시 후"
- ❌ "일주일이", "한 달이", "몇 년이", "몇 시간이"
- ❌ "다음 날", "그 다음", "이튿날", "그날 밤", "아침이 되자"
- ❌ "결국", "마침내", "드디어", "끝내", "이윽고"
- ❌ "그렇게 해서", "그리하여", "그렇게", "이렇게 해서"
- ❌ "한편", "그 시각", "다른 곳에서는", "그때", "그 순간"
- ❌ "그 사이", "그 동안", "그러는 동안", "그러던 중"
...
╔══════════════════════════════════════════════════════════════════╗
║  ⛔⛔⛔ 같은 유형의 장면 = 전체 작품에서 1번만!!! ⛔⛔⛔       ║
║  ⛔⛔⛔ 이전 씬과 비슷한 장면 = 즉시 실패!!! ⛔⛔⛔            ║
╚══════════════════════════════════════════════════════════════════╝

**반복 금지 장면 (전체 작품에서 1번만 허용):**
- ❌ 각성/깨달음 장면 - 1번만!
- ❌ 힘 획득/능력 각성 장면 - 1번만!
- ❌ 결심/다짐/맹세 장면 - 1번만!
- ❌ 화해/용서 장면 - 같은 관계에서 1번만!
- ❌ 고백/감정 표현 장면 - 같은 관계에서 1번만!
- ❌ 위기 탈출 장면 - 같은 방식으로 1번만!
- ❌ 비밀 발각 장면 - 같은 비밀 1번만!

**반복 금지 표현 (사용 금지):**
- ❌ "주먹을 불끈", "눈빛이 변하다", "전율이"
- ❌ "심장이 뛰다", "피가 끓다", "이를 악물다"
- ❌ "눈에서 불이", "온몸이 떨리다", "가슴이 벅차다"
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
### 🔴🔴🔴 4. 종료 조건 엄격 준수 (CRITICAL!!!) 🔴🔴🔴
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

╔══════════════════════════════════════════════════════════════════╗
║  ⛔ 종료 조건 도달 시 "---" 쓰고 즉시 멈춤!!!                   ║
║  ⛔ 종료 조건 이후 단 한 글자도 쓰면 안 됨!!!                   ║
║  ⛔ 글자수 부족해도 종료 조건 도달 시 반드시 멈춤!!!            ║
╚══════════════════════════════════════════════════════════════════╝
...
╔══════════════════════════════════════════════════════════════════╗
║  ⛔ 이미 발생한 사건을 다시 발생시키면 안 됨!!!                 ║
║  ⛔ 이미 해결된 갈등을 다시 해결하면 안 됨!!!                   ║
║  ⛔ 이미 한 결심을 다시 하면 안 됨!!!                           ║
╚══════════════════════════════════════════════════════════════════╝
...
- ❌ 이미 깨달은 것 다시 깨닫기 금지
- ❌ 캐릭터 성격 갑자기 변경 금지
- ❌ 캐릭터가 모르는 정보 알고 있는 것처럼 행동 금지
- 💀 사망 캐릭터: 현재 시점에서 등장 불가 (회상만)
- 🔒 감금 캐릭터: 해당 장소에서만 등장
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
### 📝 7. 기획 데이터 필수 반영 (100% 반영 필수!!!)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

╔══════════════════════════════════════════════════════════════════╗
║  ⛔ 위에서 제공된 모든 기획 데이터를 반드시 반영하세요!!!       ║
║  ⛔ 캐릭터 프로필, 세계관, 플롯, 복선, 갈등 모두 반영!!!        ║
╚══════════════════════════════════════════════════════════════════╝

- ✅ **캐릭터 프로필**: 성격, 말투, 목표, 두려움, 비밀 등 모두 반영
- ✅ **캐릭터 말투**: 각 캐릭터의 고유한 말투 패턴 100% 유지
- ✅ **캐릭터 입버릇**: 정의된 입버릇 자연스럽게 사용
- ✅ **캐릭터 관계**: 현재 관계 상태에 맞게 대화/행동
- ✅ **세계관 설정**: 시대, 사회, 문화 등 모두 반영
- ✅ **플롯 구조**: 현재 단계에 맞는 내용만 작성
- ✅ **복선**: 자연스럽게 심되 노골적이지 않게
- ✅ **갈등**: 현재 활성화된 갈등만 진행
...
╔══════════════════════════════════════════════════════════════════╗
║  ⛔ 분량 채우려고 새 사건/인물/장소 추가 절대 금지!!!           ║
║  ✅ 분량 부족 시 → 현재 장면의 감정/분위기/디테일을 깊게!!!     ║
╚══════════════════════════════════════════════════════════════════╝

- 글자수가 조금 부족해도 종료 조건 도달 시 반드시 멈춤
- 분량 부족 시 **현재 장면의 감정/분위기/디테일을 깊게**
- 분량을 채우려고 다음 씬 내용 미리 쓰기 금지
- 분량을 채우려고 새로운 사건/갈등 만들기 금지
- 분량을 채우려고 새로운 인물 등장시키기 금지
- 분량을 채우려고 새로운 장소 이동시키기 금지

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
### 🔴🔴🔴 9. 빈 괄호 및 불필요한 특수문자 금지 (CRITICAL!!!) 🔴🔴🔴
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
**절대 금지 (사용 시 즉시 실패):**
- ❌ 빈 괄호 () 사용 금지 - 어떤 경우에도!!!
- ❌ "단어()" 형태 금지 - 괄호 안이 비어있으면 괄호 자체를 쓰지 말 것
- ❌ 불필요한 괄호 사용 금지 - 설명이 필요 없으면 괄호 쓰지 말 것
- ❌ 한자 병기할 때 빈 괄호 금지 - "황진(黃進)" OK, "황진()" 안 됨
...
## 🔒 씬 범위 (이 범위 밖 내용 절대 금지!)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
📍 **장소**: ${scene.location || '미정'} (이 장소에서만 진행!)
⏰ **시간**: ${scene.timeframe || '미정'} (시간 점프 금지!)
👥 **등장인물**: ${scene.participants.join(', ') || '미정'} (이 인물들만 등장!)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

## 씬 설정
- 시점(POV): ${scene.pov} (${povTypeMap[scene.povType] || '3인칭 제한'})

## 🚨🚨🚨 이 씬의 범위 (CRITICAL - 가장 중요!) 🚨🚨🚨
┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
┃ 🟢 시작: "${scene.startCondition || '이전 씬에서 자연스럽게 이어짐'}"
┃ 🔴 종료: "${scene.endCondition}"
┃ 종료 유형: ${scene.endConditionType === 'dialogue' ? '대사' : scene.endConditionType === 'action' ? '행동' : '서술'}
┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛

## ⛔ 절대 금지 (위반 시 생성 실패!)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
1. ❌ **시작점 이전 내용 작성 금지** - 이 씬 이전 이야기 쓰지 마세요
2. ❌ **종료점 이후 내용 작성 금지** - 종료 조건 도달 후 멈추세요
3. ❌ **다음 씬 내용 미리 작성 금지** - 절대로 다음 씬을 쓰지 마세요
4. ❌ **시간 점프 금지** - "며칠 후", "다음 날", "한참 후" 등 금지
5. ❌ **장소 변경 금지** - 위에 지정된 장소에서만 진행
6. ❌ **등장인물 추가 금지** - 위에 지정된 인물만 등장
7. ❌ **반복 금지** - 이전 씬과 비슷한 장면/대사 금지
8. ❌ **새로운 사건 만들기 금지** - mustInclude에 없는 사건 추가 금지
9. ❌ **분량 채우기 금지** - 새 사건으로 분량 채우지 말고 디테일로 채우세요
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

## ✅ 이 씬에서 작성할 내용 (오직 이것만!!! 절대 다른 것 추가 금지!!!)

╔══════════════════════════════════════════════════════════════════════════════╗
║ ⛔⛔⛔ 경고: 아래 mustInclude 목록 외에는 어떤 것도 추가하면 안 됩니다!!! ⛔⛔⛔ ║
║ ⛔⛔⛔ 새로운 사건, 갈등, 결심, 깨달음, 각성 등 만들기 절대 금지!!! ⛔⛔⛔    ║
║ ⛔⛔⛔ 분량 부족 시 → 새 사건 금지!!! → 감정/분위기/디테일로 채우세요!!! ⛔⛔⛔ ║
╚══════════════════════════════════════════════════════════════════════════════╝

### 📋 mustInclude (이것만 작성하세요!!!):
...
### ✅ 분량이 부족할 때 해야 할 것:
- 현재 장면의 감정을 더 깊게 묘사
- 현재 장면의 분위기를 더 섬세하게 묘사
- 인물의 내면 심리를 더 세밀하게 표현
- 대화의 뉘앙스와 간극을 더 풍부하게
- 배경과 환경 묘사를 더 풍성하게

${previousSceneSummary ? `## 직전 씬 요약 (참고용 - 이 내용은 다시 쓰지 말 것!)\n${previousSceneSummary}\n` : ''}
...
${scene.nextScenePreview ? `## ⚠️ 다음 씬 예고 (참고만! 절대 이 내용을 쓰지 말 것!)\n${scene.nextScenePreview}\n⚠️ 위 내용은 다음 씬에서 작성됩니다. 이 씬에서 쓰면 안 됩니다!\n` : ''}

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
## 🎯 필수 체크리스트 (집필 전 반드시 확인!)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

### 🔴 씬 범위 (가장 중요!)
- [ ] 이 씬은 "${scene.startCondition || '이전 씬에서 이어짐'}"에서 시작
- [ ] 이 씬은 "${scene.endCondition}"에서 끝남
- [ ] 장소: ${scene.location || '미정'}에서만 진행
- [ ] 등장인물: ${scene.participants.join(', ') || '미정'}만 등장
- [ ] 시간 점프 절대 금지 (며칠 후, 다음 날 등 사용 금지)

### 🔴 스토리 점프 방지
- [ ] "며칠이 지나", "시간이 흘러" 등 시간 점프 표현 금지
- [ ] "결국", "마침내", "드디어" 등 요약 표현 금지
- [ ] 갑자기 장소가 바뀌면 안 됨
- [ ] 갑자기 새로운 인물이 등장하면 안 됨

### 🔴 반복 방지
- [ ] 이전 씬에서 나온 장면/대사 다시 쓰기 금지
- [ ] 각성/깨달음/결심 장면 반복 금지
- [ ] 비슷한 감정 묘사 반복 금지
...
╔════════════════════════════════════════════════════════════════════════════╗
║ ⛔ 이 씬은 오직 "${scene.startCondition || '이전 씬에서 이어짐'}"부터     ║
║ ⛔ "${scene.endCondition}"까지의 순간만 묘사!!!                           ║
║ ⛔ 그 이전/이후 내용은 단 한 줄도 쓰지 말 것!!!                          ║
║ ⛔ 전체 스토리를 압축하지 말 것!!! 이 씬의 순간만 집중!!!                ║
╚════════════════════════════════════════════════════════════════════════════╝

1. 📍 장소 "${scene.location || '미정'}"에서만 진행
2. 👥 등장인물 "${scene.participants.join(', ') || '미정'}"만 등장
3. 🟢 시작: "${scene.startCondition || '이전 씬에서 이어짐'}"
4. 🔴 종료: "${scene.endCondition}" 도달 시 "---" 쓰고 즉시 멈춤
5. ⏰ 시간 점프/요약 표현 절대 금지
6. 🔄 이전 씬과 반복되는 내용 금지
7. 📏 글자수 조금 부족해도 종료 조건 도달 시 멈춤
8. 🚫 이 씬 종료 후의 미래 이야기 절대 쓰지 말 것!!!
9. 🚫 임진왜란, 전쟁, 승리 등 미래 사건 미리 묘사 금지!!!
10. 🚫 전체 스토리를 1씬에 압축하지 말 것!!!
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━`;
